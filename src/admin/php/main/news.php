...
if (!empty($newsId) && $status === 'update') {
  ...
  // 投稿 or 保存
} elseif ($status === 'post' || $status === 'save') {
      ...
      <form id="form" action="" method="post" enctype="multipart/form-data">
        <div>
          ...
          <div class="form-group col-5 mb-3">
            ...
            <input class="form-control" id="postDate" type="datetime-local" name="postDate" value="<?php echo h($postDate); ?>" required>
          </div>
          <!-- タイトル -->
          <div class="form-group col-5 mb-3">
            <label for="postTitle">タイトル</label>
            <input id="postTitle" class="form-control" name="postTitle" value="<?php echo h($postTitle); ?>" required>
          </div>
          <!-- 画像 -->
          <div class="form-group col-5 mb-3">
          ...
          <div class="form-group col-8 mb-3">
            ...
            <textarea id="postText" class="form-control" name="postText" rows="6" cols="40" required><?php echo h($postText); ?></textarea>
          </div>
        </div>
